...
- **创建桌面快捷方式**：创建“Codex Desktop Patch”和“Codex Desktop Patch Manager”两个桌面快捷方式。
...
| `Codex Desktop Patch Manager` | 打开管理器，进行更新、版本、设置、日志和修复操作 |
...
双击“Codex Desktop Patch Manager”，可以看到当前版本、安装目录、自动检查状态和最近一次检查结果。
...
- 桌面：`Codex Desktop Patch.lnk`、`Codex Desktop Patch Manager.lnk`。
- 开始菜单：`Codex Desktop Patch.lnk`、`Codex Desktop Patch Manager.lnk`。
...
2. 删除桌面和开始菜单中的以下快捷方式：
   ...
   - `Codex Desktop Patch Manager.lnk`
